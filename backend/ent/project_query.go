...
func (_q *ProjectQuery) QueryActions() *ActionModelQuery {
...
func (_q *ProjectQuery) WithActions(opts ...func(*ActionModelQuery)) *ProjectQuery {
	query := (&ActionModelClient{config: _q.config}).Query()
...
func (_q *ProjectQuery) loadActions(ctx context.Context, query *ActionModelQuery, nodes []*Project, init func(*Project), assign func(*Project, *ActionModel)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(actionmodel.FieldProjectID)
	}
