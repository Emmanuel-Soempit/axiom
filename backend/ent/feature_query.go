...
func (_q *FeatureQuery) QueryProject() *ProjectQuery {
...
func (_q *FeatureQuery) QueryAgent() *AgentQuery {
...
func (_q *FeatureQuery) QueryActions() *ActionModelQuery {
...
func (_q *FeatureQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *FeatureQuery) FirstIDX(ctx context.Context) int {
...
func (_q *FeatureQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *FeatureQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *FeatureQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *FeatureQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *FeatureQuery) WithProject(opts ...func(*ProjectQuery)) *FeatureQuery {
	query := (&ProjectClient{config: _q.config}).Query()
...
func (_q *FeatureQuery) WithAgent(opts ...func(*AgentQuery)) *FeatureQuery {
	query := (&AgentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *FeatureQuery) WithActions(opts ...func(*ActionModelQuery)) *FeatureQuery {
	query := (&ActionModelClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *FeatureQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Feature, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, feature.ForeignKeys...)
	}
	...
	if query := _q.withProject; query != nil {
		if err := _q.loadProject(ctx, query, nodes, nil,
			func(n *Feature, e *Project) { n.Edges.Project = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAgent; query != nil {
		if err := _q.loadAgent(ctx, query, nodes,
			func(n *Feature) { n.Edges.Agent = []*Agent{} },
			func(n *Feature, e *Agent) { n.Edges.Agent = append(n.Edges.Agent, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withActions; query != nil {
		if err := _q.loadActions(ctx, query, nodes,
			func(n *Feature) { n.Edges.Actions = []*ActionModel{} },
			func(n *Feature, e *ActionModel) { n.Edges.Actions = append(n.Edges.Actions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *FeatureQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*Feature, init func(*Feature), assign func(*Feature, *Project)) error {
...
func (_q *FeatureQuery) loadAgent(ctx context.Context, query *AgentQuery, nodes []*Feature, init func(*Feature), assign func(*Feature, *Agent)) error {
	...
	query.Where(predicate.Agent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(feature.AgentColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.feature_agent
		if fk == nil {
			return fmt.Errorf(`foreign-key "feature_agent" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "feature_agent" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *FeatureQuery) loadActions(ctx context.Context, query *ActionModelQuery, nodes []*Feature, init func(*Feature), assign func(*Feature, *ActionModel)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Feature)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(actionmodel.FieldFeatureID)
	}
	query.Where(predicate.ActionModel(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(feature.ActionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *FeatureQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withProject != nil {
			_spec.Node.AddColumnOnce(feature.FieldProjectID)
		}
	}
