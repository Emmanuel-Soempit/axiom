...
// Where adds a new predicate for the ActionModelQuery builder.
func (_q *ActionModelQuery) Where(ps ...predicate.ActionModel) *ActionModelQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *ActionModelQuery) Limit(limit int) *ActionModelQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *ActionModelQuery) Offset(offset int) *ActionModelQuery {
...
func (_q *ActionModelQuery) Unique(unique bool) *ActionModelQuery {
...
// Returns a *NotFoundError when no ActionModel was found.
func (_q *ActionModelQuery) First(ctx context.Context) (*ActionModel, error) {
	nodes, err := _q.Limit(1).All(setContextOp(ctx, _q.ctx, ent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{actionmodel.Label}
	}
	return nodes[0], nil
}

// FirstX is like First, but panics if an error occurs.
func (_q *ActionModelQuery) FirstX(ctx context.Context) *ActionModel {
...
// FirstID returns the first ActionModel ID from the query.
// Returns a *NotFoundError when no ActionModel ID was found.
func (_q *ActionModelQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ActionModelQuery) FirstIDX(ctx context.Context) int {
...
// Only returns a single ActionModel entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one ActionModel entity is found.
// Returns a *NotFoundError when no ActionModel entities are found.
func (_q *ActionModelQuery) Only(ctx context.Context) (*ActionModel, error) {
	...
	case 0:
		return nil, &NotFoundError{actionmodel.Label}
	default:
		return nil, &NotSingularError{actionmodel.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (_q *ActionModelQuery) OnlyX(ctx context.Context) *ActionModel {
...
// OnlyID is like Only, but returns the only ActionModel ID in the query.
// Returns a *NotSingularError when more than one ActionModel ID is found.
// Returns a *NotFoundError when no entities are found.
func (_q *ActionModelQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	...
	case 0:
		err = &NotFoundError{actionmodel.Label}
	default:
		err = &NotSingularError{actionmodel.Label}
	}
	return
}

// OnlyIDX is like OnlyID, but panics if an error occurs.
func (_q *ActionModelQuery) OnlyIDX(ctx context.Context) int {
...
// All executes the query and returns a list of ActionModels.
func (_q *ActionModelQuery) All(ctx context.Context) ([]*ActionModel, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*ActionModel, *ActionModelQuery]()
	return withInterceptors[[]*ActionModel](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *ActionModelQuery) AllX(ctx context.Context) []*ActionModel {
...
// IDs executes the query and returns a list of ActionModel IDs.
func (_q *ActionModelQuery) IDs(ctx context.Context) (ids []int, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(actionmodel.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ActionModelQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ActionModelQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*ActionModelQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *ActionModelQuery) CountX(ctx context.Context) int {
...
func (_q *ActionModelQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *ActionModelQuery) ExistX(ctx context.Context) bool {
...
// Clone returns a duplicate of the ActionModelQuery builder, including all associated steps. It can be
// used to prepare common query builders and use them differently after the clone is made.
func (_q *ActionModelQuery) Clone() *ActionModelQuery {
	if _q == nil {
		return nil
	}
...
func (_q *ActionModelQuery) GroupBy(field string, fields ...string) *ActionModelGroupBy {
	...
	grbuild := &ActionModelGroupBy{build: _q}
	grbuild.flds = &_q.ctx.Fields
	grbuild.label = actionmodel.Label
...
func (_q *ActionModelQuery) Select(fields ...string) *ActionModelSelect {
	...
	sbuild := &ActionModelSelect{ActionModelQuery: _q}
	sbuild.label = actionmodel.Label
	sbuild.flds, sbuild.scan = &_q.ctx.Fields, sbuild.Scan
	return sbuild
}

// Aggregate returns a ActionModelSelect configured with the given aggregations.
func (_q *ActionModelQuery) Aggregate(fns ...AggregateFunc) *ActionModelSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *ActionModelQuery) prepareQuery(ctx context.Context) error {
...
func (_q *ActionModelQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(actionmodel.Table, actionmodel.Columns, sqlgraph.NewFieldSpec(actionmodel.FieldID, field.TypeInt))
	_spec.From = _q.sql
...
func (_q *ActionModelQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(_q.driver.Dialect())
	t1 := builder.Table(actionmodel.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = actionmodel.Columns
	}
...
// ActionModelGroupBy is the group-by builder for ActionModel entities.
type ActionModelGroupBy struct {
	selector
	build *ActionModelQuery
}

// Aggregate adds the given aggregation functions to the group-by query.
func (_g *ActionModelGroupBy) Aggregate(fns ...AggregateFunc) *ActionModelGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *ActionModelGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ActionModelQuery, *ActionModelGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *ActionModelGroupBy) sqlScan(ctx context.Context, root *ActionModelQuery, v any) error {
...
// ActionModelSelect is the builder for selecting fields of ActionModel entities.
type ActionModelSelect struct {
	*ActionModelQuery
	selector
}

// Aggregate adds the given aggregation functions to the selector query.
func (_s *ActionModelSelect) Aggregate(fns ...AggregateFunc) *ActionModelSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *ActionModelSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*ActionModelQuery, *ActionModelSelect](ctx, _s.ActionModelQuery, _s, _s.inters, v)
}

func (_s *ActionModelSelect) sqlScan(ctx context.Context, root *ActionModelQuery, v any) error {
