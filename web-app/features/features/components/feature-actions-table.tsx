...
import { httpDeleteAction } from '../apis';
import { toast } from 'react-hot-toast';

interface FeatureActionsTableProps {
    data: Action[];
    isLoading?: boolean;
}

export const FeatureActionsTable: React.FC<FeatureActionsTableProps> = ({ data, isLoading }) => {
    ...
    const handleActionClick = (action: Action) => {
        router.push(`/project/${projectId}/features/${featureId}/actions/${action.id}`);
    };
    ...
    return (
        <>
            <DataTable
                ...
                columns={columns}
                isLoading={isLoading}
                emptyMessage="No actions found for this feature."
            />
