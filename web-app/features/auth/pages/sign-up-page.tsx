...
export const SignUpPage: React.FC = () => {
    return (
        <main className="flex min-h-screen items-center justify-center px-4 py-10">
            <div className="relative max-w-lg w-[50%]">
                {/* Background Decor */}
                ...
                <Card className="relative z-10 overflow-hidden border-white/10 bg-slate-50 backdrop-blur-xl">
                    <div className="flex flex-col gap-6 p-4">
                        <div className="flex flex-col items-center gap-2 text-center">
                            ...
                            <Text variant="md" className="text-slate-400">
                                Join EAC and start automating your workflow
                            </Text>
                        </div>
                        ...
                        <div className="relative flex items-center gap-2 py-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-slate-600">OR JOIN WITH</span>
                            <div className="h-px flex-1 bg-white/5"></div>
                        </div>
                        ...
                        <p className="mt-2 text-center text-xs text-slate-500">
                            ...
                            <a href="/sign-in" className="font-semibold text-gray-400 hover:text-primary transition-colors">
                                Sign In
                            </a>
                        </p>
                    </div>
